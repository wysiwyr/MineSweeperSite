let Post,mongoose,Joi,sanitizeHtml;_dec‍.x([["getPostById",()=>getPostById],["checkOwnPost",()=>checkOwnPost],["write",()=>write],["list",()=>list],["read",()=>read],["remove",()=>remove],["update",()=>update]]);_dec‍.w("../../models/post",[["default",["Post"],function(v){Post=v}]]);_dec‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_dec‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_dec‍.w("sanitize-html",[["default",["sanitizeHtml"],function(v){sanitizeHtml=v}]]);
